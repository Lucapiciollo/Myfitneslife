...
- `:app:connectedDebugAndroidTest` verde: 54/54 test su `SM-A546B - 16`, inclusi smoke Activity, bottom navigation, QaSeeder, Progress, Settings, Export, notifiche, migration/usage runtime, sessione profilo attivo, E2E consumo pasto, gate sgarro e formati export.
...
- [x] E2E UI export verificato per JSON, CSV ZIP e PDF profilo; PDF piano richiede dataset piano completo e la foto etichetta reale resta aperta.
...
- [x] Rieseguire la suite connected completa dopo il gate Alimentazione e la nuova UI delle credenziali: 54/54 PASS su `SM-A546B - 16`.
