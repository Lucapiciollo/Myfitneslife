...
- `:app:connectedDebugAndroidTest` verde: 29 test eseguiti su `SM-A546B - 16`.
...
- La suite instrumented copre persistenza Room, riapertura di un database persistente temporaneo, piani legacy senza supplementi, migration 3 -> 4, export JSON/CSV ZIP/PDF, isolamento multiprofilo inclusi record annidati di piano, workflow AI deterministici con fake runtime provider-neutral, scheduler notifiche deterministico, lifecycle foto etichetta e conservazione di supplementi/hydration note.
