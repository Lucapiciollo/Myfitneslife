...
- [x] Prima fase sgarro testuale migrata sulla pipeline AI comune: comprensione e stima passano da WorkManager, preview restituita senza persistenza e conferma/adattamento restano un'azione separata con fingerprint anti-stale. L'allegato foto resta da migrare tramite file temporaneo privato nel job, senza passare dati immagine in chiaro nei parametri.
