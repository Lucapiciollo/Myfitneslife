...
Componenti ancora da creare secondo la specifica ricevuta (MetaCardView e TimeRangeSelectorView coprono già Home; mancano ancora MacroChipView, ProgressMetricView, SelectableSegmentView, WeekDaySelectorView, DayCellView, ProfileHeaderView, EmptyStateView, BodyCompositionChartView, ProgressChartView, MiniProgressMetricView, MeasurementRowView, HistoryRowView, ShoppingItemRowView, IngredientRowView): verranno creati quando la rispettiva schermata sarà affrontata, per evitare codice non utilizzato scritto in anticipo.
