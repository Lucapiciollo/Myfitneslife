...
class BiaImportAiJobHandler(private val service: BiaImportService, private val images: AiImageJobStore) : AiJobHandler {
    override suspend fun execute(profileId: Long, jobKey: String, params: Data): AiJobOutcome = try {
        ...
        val payload = JSONObject()
            .put("weightKg", p.weightKg ?: JSONObject.NULL)
            .put("bodyFatPercent", p.bodyFatPercent ?: JSONObject.NULL)
            .put("visceralFatLevel", p.visceralFatLevel ?: JSONObject.NULL)
            .put("muscleMassKg", p.muscleMassKg ?: JSONObject.NULL)
            .put("skeletalMuscleKg", p.skeletalMuscleKg ?: JSONObject.NULL)
            .put("bodyWaterPercent", p.bodyWaterPercent ?: JSONObject.NULL)
            .put("bmrKcal", p.bmrKcal ?: JSONObject.NULL)
            .put("fatMassKg", p.fatMassKg ?: JSONObject.NULL)
            .put("leanMassKg", p.leanMassKg ?: JSONObject.NULL)
            .put("bodyWaterKg", p.bodyWaterKg ?: JSONObject.NULL)
            .put("subcutaneousFatPercent", p.subcutaneousFatPercent ?: JSONObject.NULL)
            .put("boneMassKg", p.boneMassKg ?: JSONObject.NULL)
            .put("proteinPercent", p.proteinPercent ?: JSONObject.NULL)
            .put("proteinKg", p.proteinKg ?: JSONObject.NULL)
            .put("bodyAgeYears", p.bodyAgeYears ?: JSONObject.NULL)
            .put("bmi", p.bmi ?: JSONObject.NULL)
            .put("measuredAtEpochMillis", p.measuredAtEpochMillis ?: JSONObject.NULL)
