 ...
 * app storage. The secret must never be logged, exported, backed up, included in
 * analytics/crash reports, or committed to source control.
 */
class SecureOpenAiKeyStore(context: Context) {
    ...
    fun load(): String? {
        ...
        return try {
            ...
            // Never leak secret material or crypto details into logs.
            null
        }
    }
