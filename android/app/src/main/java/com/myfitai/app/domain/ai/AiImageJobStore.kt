...
/**
 * Stores only the temporary image needed by a background AI job. The worker receives a private file
 * path through WorkManager, never the base64 payload, and deletes the file after the request.
 */
